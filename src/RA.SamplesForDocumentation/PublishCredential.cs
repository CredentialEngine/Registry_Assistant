...
using CredentialInput = RA.SamplesForDocumentation.SampleModels.Credential;
using CredentialOutput = RA.Models.Input.Credential;
namespace RA.SamplesForDocumentation
{
	public class PublishCredential
	{
		...
		/// In this example: 
		/// -	CredentialInput would be defined by the organization
		...
		/// <returns></returns>
	public string Publish( CredentialInput input )
		{
			...
			CredentialOutput output = new CredentialOutput
			{
				Name = input.Name,
