...
namespace RA.Services
{
    ...
    public class CredentialServices : ServiceHelper
    {
        ...
        public static void HandleUrlFields( InputEntity from, OutputEntity to, ref List<string> messages )
        {
            ...
            to.Image = AssignValidUrlAsStringList( from.Image, "Image", ref messages );
   ...
   //             to.OccupationType = null;
            ...
            {
                to.CredentialStatusType.Add( FormatCredentialAlignment( "credentialStatusType", from.CredentialStatusType, ref messages ) );
            }
            else
