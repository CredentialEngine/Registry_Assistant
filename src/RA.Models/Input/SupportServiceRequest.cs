...
namespace RA.Models.Input
{
    ...
    public class SupportService : BasePrimaryResource
    {
        ...
        /// Where the resource exists in the registry, only the Type and CTID need to be provided in the EntityReference.
        /// </summary>
        public List<EntityReference> SupportServiceFor { get; set; }
