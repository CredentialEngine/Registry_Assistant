// <copyright file="ConditionProfile.cs" company="Credential Engine">
...
namespace RA.Models.Input
{
	...
	public class ConditionProfile
	{
		...
		public ConditionProfile()
		{
			...
			Affiliation = new List<OrganizationReference>();
		...
		/// </summary>
		public List<OrganizationReference> Affiliation { get; set; }
		...
		public LanguageMapList ConditionLangMap { get; set; } = null;
		...
		public LanguageMap ExperienceLangMap { get; set; }
		...
		public LanguageMap SubmissionOfDescriptionLangMap { get; set; } = null;
		...
		///		"isPreparationFor"/"IsRecommendedFor"/ isRequiredFor"
		/// </summary>
		public List<EntityReference> TargetTask { get; set; } = new List<EntityReference>();
