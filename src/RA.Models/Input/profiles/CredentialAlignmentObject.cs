...
namespace RA.Models.Input
{
	...
	public class CredentialAlignmentObject
	{
		...
		public LanguageMap FrameworkNameLangMap { get; set; } = null;
		...
		public LanguageMap TargetNodeNameLangMap { get; set; } = null;
		...
		public LanguageMap TargetNodeDescriptionLangMap { get; set; } = null;
