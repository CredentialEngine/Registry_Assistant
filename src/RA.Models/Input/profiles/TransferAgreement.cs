...
namespace RA.Models.Input
{
    ...
    public class TransferAgreement
	{
		...
		{
			Type = "ceterms:TransferAgreement";
		...
		/// BNodes are not allowed
		/// </summary>
		public List<OrganizationReference> ReceivingOrganization { get; set; }
		...
		/// BNodes are not allowed
		/// </summary>
		public List<OrganizationReference> SendingOrganization { get; set; }
        ...
        /// ConceptScheme: ceterms:AgreementCategory
        /// </summary>
        public List<string> AgreementType { get; set; }
        ...
        /// Bnodes are allowed>
        /// </summary>
        public List<OrganizationReference> ReceivingDepartment { get; set; }
        ...
        /// Bnodes are allowed>
        /// </summary>
        public List<EntityReference> ReceivingProgram { get; set; }
		...
		/// Bnodes are allowed>
		/// </summary>
		public List<OrganizationReference> SendingDepartment { get; set; }
        ...
        /// Bnodes are allowed>
        /// </summary>
        public List<EntityReference> SendingProgram { get; set; }
