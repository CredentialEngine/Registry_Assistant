...
namespace RA.Models.Input.profiles.QData
{
    ...
    public class Metric : BasePrimaryResource
    {
        ...
        public LanguageMap AdjustmentMap { get; set; }
        ...
        public LanguageMap EarningsDefinitionMap { get; set; }
        ...
        public LanguageMap EarningsThresholdMap { get; set; }
        ...
        public LanguageMap EmploymentDefinitionMap { get; set; }
