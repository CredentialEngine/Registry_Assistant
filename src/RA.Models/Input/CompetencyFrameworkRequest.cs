...
namespace RA.Models.Input
{
	...
	public class CompetencyFramework
	{
		...
		public LanguageMap TableOfContentsLangMap { get; set; } = new LanguageMap();
	...
	public class Competency
	{
		...
		public LanguageMap CompetencyCategoryLangMap { get; set; } = null;
		...
		public LanguageMap CompetencyTextLangMap { get; set; } = null;
		...
		public LanguageMap CompetencyLabelLangMap { get; set; } = new LanguageMap();
		...
		public LanguageMapList Keyword_LangMap { get; set; } = new LanguageMapList();
