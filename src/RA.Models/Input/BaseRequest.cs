...
namespace RA.Models.Input
{
	public class BaseRequest
	{
		...
		/// <summary>
		/// Set to true to NOT include the formatted JSON object in the response (perhaps for performance concerns)
		/// </summary>
		public bool ExcludingPayloadInResponse { get; set; }
