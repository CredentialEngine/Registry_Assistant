...
namespace RA.Models.Input
{
	...
	public class CopyRequest : BaseRequest
	{
		...
		/// <summary>
		/// Optionally provide a list of CTIDs for records to copy
	...
	public class Credential : BaseRequestHelper
	{
		...
		public LanguageMapList DegreeMajorLangMap { get; set; } = new LanguageMapList();
		...
		public LanguageMapList DegreeMinorLangMap { get; set; } = new LanguageMapList();
