...
namespace RA.Models.JsonV2
{
	...
	{
		[JsonIgnore]
		public static string classType { get; } = "ceterms:CredentialOrganization";
		...
		/// </summary>
		[JsonProperty( "ceterms:inDemandAction" )]
		...
		//public object HasVerificationService { get; set; }
