...
namespace RA.Models.JsonV2
{
	...
	public class ProgressionLevel
	{
		...
		/// </summary>
		[JsonProperty( "ceterms:facetedDescription" )]
		...
		/// </summary>
		[JsonProperty( PropertyName = "ceterms:indicativeCredentialType" )]
	...
	public class ProgressionModelContainer
	{
		public ProgressionModelContainer()
		{
