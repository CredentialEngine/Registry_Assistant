...
namespace RA.SamplesForDocumentation
{
	public class CommonClasses
	{
		...
		public static void PopulateOccupations( CredentialRequest request)
		{
			request.Credential.OccupationType = new List<FrameworkItem>();

			//occupations from a framework like ONet - where the information is stored locally
			request.Credential.OccupationType.Add( new FrameworkItem() 
			{
			...
			request.Credential.AlternativeOccupationType = new List<string>() { "Cybersecurity", "Forensic Scientist", "Forensic Anthropologist" };
			...
			request.Credential.ONET_Codes = new List<string>() { "13-2099.01", "13-2052.00", "13-2061.00", "13-2051.00" };
		}
