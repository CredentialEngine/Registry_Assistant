...
{
    public class PublishLearningOpportunityWithOutcomes
    {
		/// <summary>
		/// Publish a learningOpportunity with aggregate data
		/// sandbox registry: <see cref="https://sandbox.credentialengineregistry.org/graph/ce-f5b8d26a-690a-4671-bda6-d8fc92647a05"/>
		/// sandbox finder: <see cref="https://sandbox.credentialengine.org/finder/learningOpportunity/ce-f5b8d26a-690a-4671-bda6-d8fc92647a05"/>
		/// <param name="requestType">Format or Publish</param>
		public bool LearningOpportunityWithOutcomeData( string requestType = "format" )
		{
		...
		private AggregateDataProfile FormatAggregateDataProfile( string owningOrganizationCTID )
		{
			...
			dataProfile.NonHoldersInSet.Add( SampleServices.AddQuantitativeValue( 44, "Non-holder subject actively pursuing the learningOpportunity through a program or assessment." ) );
			//
			...
			dataProfile.RelatedEmployment.Add( SampleServices.AddQuantitativeValue( 321, "Number of people employed in the area of work (e.g., industry, occupation) in which the LearningOpportunity provided preparation." ) );
			dataProfile.SubjectsInSet.Add( SampleServices.AddQuantitativeValue( 235, "Total LearningOpportunity holders and non-holders in the final data collection and reporting." ) );
			...
			dataProfile.UnrelatedEmployment.Add( SampleServices.AddQuantitativeValue( 55, "Number of people employed outside the area of work (e.g., industry, occupation) in which the LearningOpportunity provided preparation." ) );
