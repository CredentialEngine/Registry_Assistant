...
namespace RA.SamplesForDocumentation
{
	public class PublishTransferValueProfile
	{
		...
		public string PublishSimpleRecord( bool usingSimplePost = true )
		{
			...
			myData.DerivedFrom.Add( new EntityReference()
			{
				Type = "LearningOpportunityProfile",
				Name = "Name of the third party version",
				Description = "Description of the third party version",
				SubjectWebpage = "https://example.org/thisLopp"
			} );
			//===================================================================================
			...
			//else 
			//use a method where return status can be inspected
		...
		public string PublishList()
		{
			...
			using ( var client = new HttpClient() )
			{
				...
				var publishEndpoint = "https://sandbox.credentialengine.org/assistant/transfervalueprofile/publish/";
